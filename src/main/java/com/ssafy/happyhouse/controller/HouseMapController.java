...
public class HouseMapController {
	...
	@GetMapping("/apts")
	public ResponseEntity<List<HouseInfoDto>> apts(@RequestParam("gugun") String gugun) throws Exception {
		return new ResponseEntity<List<HouseInfoDto>>(haHouseMapService.getAptInGugun(gugun), HttpStatus.OK);
	}
	
	@GetMapping("/aptName")
	public ResponseEntity<List<HouseInfoDto>> aptName(@RequestParam("apt") String aptName) throws Exception {
